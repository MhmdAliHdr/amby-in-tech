...
function Footer() {
    ...
    return (
        ...
        <a href={`tel:${footerInfo.phoneNumber.replace(/\s/g, "")}`}>{footerInfo.phoneNumber}</a>
        </b>
        </div>
    )
}
