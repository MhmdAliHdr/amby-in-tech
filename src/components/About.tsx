...
function About(){
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 ml-auto mr-auto bg-[#261732] text-[#D6D0C5]">
            ...
            <img className="w-full mx-auto rounded-full aspect-square object-cover object-top md:aspect-auto md:rounded-none max-w-xs md:max-w-none md:w-1/2 md:ml-90" src={about.realImg} alt="portrait of Amby"></img>
